...
<div class="container d-flex justify-content-center align-items-center" style="margin-top: 60px">
    <div class="card" style="width: 35%; background-color: #94AF9F;">
        <div class="card-body p-4">
            <h3 class="card-title text-center">Login</h3>
            <form action="{{ route('postLogin') }}" method="POST">
                @csrf
                <div class="form-group mt-4">
                <label class="text-secondary" style="color: #FFFFFF;">Email Anda</label>
                ...
                <label class="text-secondary" style="color: #000;">Password anda</label>
                ...
                <button type="submit" class="form-control btn btn-success mt-5">Login</button>
            </form>

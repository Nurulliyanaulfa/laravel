    ...
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item" style="margin-left: 30px">
                <a class="nav-link active" href="{{ route('admin.buku') }}" style="color: white;">Buku</a>
            </li>
            <li class="nav-item" style="margin-left: 30px">
                <a class="nav-link" href="#" style="color: white;">Peminjaman</a>
            </li>
        </ul>
    </div>
</nav>
                        ...
                        <form action="/postEditAdmin/{{ $data->id }}" method="POST">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenisKelamin" value="Laki-laki" @if ($data->jenis_kelamin == 'Laki-laki') checked="checked" @endif>
                                    <label class="form-check-label" for="inlineRadio1">Laki-laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenisKelamin" value="Perempuan" @if ($data->jenis_kelamin == 'Perempuan') checked="checked" @endif>
